...
eyesocket_data = [
	('eyesocket_in_upper_ctl',  ['eyesocket_in_ctl', 'eyesocket_mid_upper_ctl'],  'follow'),
	('eyesocket_out_upper_ctl', ['eyesocket_out_ctl', 'eyesocket_mid_upper_ctl'], 'follow'),
	('eyesocket_in_lower_ctl',  ['eyesocket_in_ctl', 'eyesocket_mid_lower_ctl'],  'follow'),
	('eyesocket_out_lower_ctl', ['eyesocket_out_ctl', 'eyesocket_mid_lower_ctl'], 'follow'),
	('eyesocket_mid_upper_ctl', ['eye_main_ctl', 'eyebrow_main_ctl'], 'follow_eyebrow'),
	('eyesocket_mid_lower_ctl', ['eye_main_ctl', 'cheek_main_ctl'], 'follow_cheek')
]
...
for side in ['l_', 'r_']:
	for ctrl, parents, attr in eyesocket_data:
		...
		parents = [f'{side}{p}' for p in parents]
		bb.add_follow_attr(
			parents=parents, 
			target=follow_grp, 
			attr_name=attr, 
